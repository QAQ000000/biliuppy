    ...
    <>
      <Collapse.Panel header="哔哩哔哩" itemKey="bilibili">
        <Form.Select
          ...
          extraText={
            <div style={{ fontSize: '14px' }}>
              哔哩哔哩自选画质。默认原画。
              <br />
              刚开播如果无选择的画质，会先录制原画，后续视频分段时切换到选择的画质。
              <br />
        ...
        <Form.Switch
          ...
          extraText="录制哔哩哔哩弹幕，目前不支持视频按时长分段下的弹幕文件自动分段，默认关闭。"
        ...
        <Form.Input
          ...
          extraText={
            <div className="semi-form-field-extra">
              根据格式填入 Cookie，或在用户管理中扫码登录后选择 Cookie 文件。
              <br />
            </div>
          }
        ...
        <Form.Select
          ...
          optionList={list}
          extraText="支持扫码登录生成的标准 Cookie 文件。与 Cookie 文本同时存在时，优先使用文件。"
          showClear={true}
        />
        <Form.Select
          field="bili_protocol"
          extraText={
            <div style={{ fontSize: '14px' }}>
              ...
              <br />
              hls_fmp4 建议使用 streamlink；其他直播流默认使用 ffmpeg。
            </div>
          }
        ...
        <Form.Input
          ...
          extraText={
            <div style={{ fontSize: '14px' }}>
              ...
              API，然后优选「fmp4」流，最后设置优选「cn-gotcha204,ov-gotcha05」两个节点。
