      ...
      <div className={styles.main}>
        <div className={styles.login}>
          <div className={styles.component66}>
            <Image src="/logo.png" className={styles.logo} alt="logo" width={72} height={72} />
            <div className={styles.header}>
              <p className={styles.title}>{isRegisterMode ? '欢迎注册' : '欢迎回来'}</p>
              <p className={styles.text3}>
                <span className={styles.text}>{isRegisterMode ? '注册' : '登录'}</span>
          ...
          <div className={styles.form}>
            <Form className={styles.inputs}>
              <Form.Input
                label={{ text: '用户名' }}
                field="username"
                fieldStyle={{ padding: 0, width: '100%' }}
                style={{ width: '100%' }}
